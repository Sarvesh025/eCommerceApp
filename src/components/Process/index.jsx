...
export default function index() {
  return (
    <div className={styles.processContainer}>
      ...
      <h1 style={{fontFamily:'math'}}>Key Feature</h1>
      <h3>No Quality Restrictions</h3>
      </div>
    <div className={styles.process}>
        <div className={styles.image}></div>
        <Card heading="Own Manufacturing" content="Own Manufacturing T-Shirts With Your Fit And Style For Men,Women,Kids Choose From 50+ Shades Of Color Fabrics" position={{top:'0', left:'0'}}/>
